## code to produce plots for "Discovering universal temperature regulation dynamics in animals" 

### matlab scripts for each figure and supplement in fig1, fig2, fig3, fig4, fig5 and supplemental figs. 
